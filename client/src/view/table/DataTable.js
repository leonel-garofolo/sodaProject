  ...
  return (
    <div className="ag-theme-alpine" style={{height: 400}}>
           <AgGridReact               
               ...
               <AgGridColumn field="num_address"  headerName="Numero" sortable={ true } filter={true} floatingFilter={true} maxWidth="130" />
               <AgGridColumn field="price_per_soda" headerName="Precio x Soda" />
               <AgGridColumn field="price_per_box" headerName="Precio x Cajon" />
